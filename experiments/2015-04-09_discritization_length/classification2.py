...
if __name__ == "__main__":
    ...
    text_clf6 = Pipeline([  #('decode', UnicodeTransform()),
                            ...
                            ('internalpipe', Pipeline([
                                ('vect', CountVectorizer(ngram_range=(1,2), binary=True)),
                                #('peek', MatrixPeekTransform(100000))
                            ])),
                            ...
                            #('pii', TermTransformer(["zip","age","name","date of birth", "credit card number", "email address", "e-mail address", "personal information", "personally identifiable"])),
