...
if __name__ == "__main__":
    ...
    text_clf4 = Pipeline([('union', FeatureUnion([
                            ('vect', CountVectorizer(ngram_range=(1,2), binary=True)),
                         ...
                         ('bayes', Perceptron(class_weight="auto"))])
    
    # fixing class weight tests
    text_clf5 = Pipeline([('union', FeatureUnion([
                            ('vect', CountVectorizer(ngram_range=(1,2), binary=True)),
                            ('dict', scikit_pipeline_steps.DictionaryTransformer()),
                            ('person', scikit_pipeline_steps.EntityTransform()),
                            #('ner', NERTransformer()),
                         ...
                         ('bayes', Perceptron(class_weight={0:.5, 1:1}))])
    ...
    text_clf6 = Pipeline([('union', FeatureUnion([
                         ...
                         ('bayes', SVC(class_weight={0:.5, 1:1},))])
    
    for k in tos.classes.keys():
        sklearn_classify(k, text_clf=text_clf6, reportwrong=False)
